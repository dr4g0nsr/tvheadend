...
profile_class_preset_list() {
    ...
    htsmsg_add_msg(l, NULL, e);
    e = htsmsg_create_map();
    htsmsg_add_str(e, "key", "placebo");
    htsmsg_add_str(e, "val", "Placebo");
    htsmsg_add_msg(l, NULL, e);
    e = htsmsg_create_map();
    htsmsg_add_str(e, "key", "veryslow");
    htsmsg_add_str(e, "val", "Veryslow");
    htsmsg_add_msg(l, NULL, e);
    e = htsmsg_create_map();
    htsmsg_add_str(e, "key", "slower");
    htsmsg_add_str(e, "val", "Slower");
    htsmsg_add_msg(l, NULL, e);
    e = htsmsg_create_map();
    htsmsg_add_str(e, "key", "slow");
    htsmsg_add_str(e, "val", "Slow");
    htsmsg_add_msg(l, NULL, e);
    e = htsmsg_create_map();
    htsmsg_add_str(e, "key", "medium");
    htsmsg_add_str(e, "val", "Medium");
    htsmsg_add_msg(l, NULL, e);
    e = htsmsg_create_map();
    htsmsg_add_str(e, "key", "fast");
    htsmsg_add_str(e, "val", "Fast");
    htsmsg_add_msg(l, NULL, e);
    e = htsmsg_create_map();
    htsmsg_add_str(e, "key", "faster");
    htsmsg_add_str(e, "val", "Faster");
    htsmsg_add_msg(l, NULL, e);
    e = htsmsg_create_map();
    htsmsg_add_str(e, "key", "veryfast");
    htsmsg_add_str(e, "val", "VeryFast");
    htsmsg_add_msg(l, NULL, e);
    e = htsmsg_create_map();
    htsmsg_add_str(e, "key", "superfast");
    htsmsg_add_str(e, "val", "SuperFast");
    htsmsg_add_msg(l, NULL, e);
    e = htsmsg_create_map();
    htsmsg_add_str(e, "key", "ultrafast");
    htsmsg_add_str(e, "val", "UltraFast");
    htsmsg_add_msg(l, NULL, e);
...
static htsmsg_t *
profile_class_x264tune_list(void *o) {
    htsmsg_t *l = htsmsg_create_list(), *e;
    ...
    htsmsg_add_msg(l, NULL, e);
    e = htsmsg_create_map();
    htsmsg_add_str(e, "key", "film");
    htsmsg_add_str(e, "val", "Film");
    htsmsg_add_msg(l, NULL, e);
    e = htsmsg_create_map();
    htsmsg_add_str(e, "key", "animation");
    htsmsg_add_str(e, "val", "Animation (for animated/3d)");
    htsmsg_add_msg(l, NULL, e);
    e = htsmsg_create_map();
    htsmsg_add_str(e, "key", "grain");
    htsmsg_add_str(e, "val", "Grain");
    htsmsg_add_msg(l, NULL, e);
    e = htsmsg_create_map();
    htsmsg_add_str(e, "key", "stillimage");
    htsmsg_add_str(e, "val", "Stillimage");
    htsmsg_add_msg(l, NULL, e);
    e = htsmsg_create_map();
    htsmsg_add_str(e, "key", "psnr");
    htsmsg_add_str(e, "val", "PSNR");
    htsmsg_add_msg(l, NULL, e);
    e = htsmsg_create_map();
    htsmsg_add_str(e, "key", "ssim");
    htsmsg_add_str(e, "val", "SSim");
    htsmsg_add_msg(l, NULL, e);
    e = htsmsg_create_map();
    htsmsg_add_str(e, "key", "fastdecode");
    htsmsg_add_str(e, "val", "FastDecode (offload client decode)");
    htsmsg_add_msg(l, NULL, e);
    e = htsmsg_create_map();
    htsmsg_add_str(e, "key", "zerolatency");
    htsmsg_add_str(e, "val", "Zerolatency (realtime)");
    htsmsg_add_msg(l, NULL, e);
...
static htsmsg_t *
profile_class_x264level_list(void *o) {
    htsmsg_t *l = htsmsg_create_list(), *e;
    ...
    htsmsg_add_msg(l, NULL, e);
    e = htsmsg_create_map();
    htsmsg_add_str(e, "key", "3.0");
    htsmsg_add_str(e, "val", "3.0 (full compatibility)");
    htsmsg_add_msg(l, NULL, e);
    e = htsmsg_create_map();
    htsmsg_add_str(e, "key", "3.1");
    htsmsg_add_str(e, "val", "3.1 (iphone 3gs+)");
    htsmsg_add_msg(l, NULL, e);
    e = htsmsg_create_map();
    htsmsg_add_str(e, "key", "4.0");
    htsmsg_add_str(e, "val", "4.0 (apple tv 3+, iphone 4+)");
    htsmsg_add_msg(l, NULL, e);
    e = htsmsg_create_map();
    htsmsg_add_str(e, "key", "4.1");
    htsmsg_add_str(e, "val", "4.1 (apple tv 3+, iphone 4+)");
    htsmsg_add_msg(l, NULL, e);
    e = htsmsg_create_map();
    htsmsg_add_str(e, "key", "4.2");
    htsmsg_add_str(e, "val", "4.2 (iphone5s+)");
    htsmsg_add_msg(l, NULL, e);
...
profile_class_x264profile_list(void *o) {
    ...
    htsmsg_add_msg(l, NULL, e);
    e = htsmsg_create_map();
    htsmsg_add_str(e, "key", "baseline");
    htsmsg_add_str(e, "val", "Baseline (more compatible)");
    htsmsg_add_msg(l, NULL, e);
    e = htsmsg_create_map();
    htsmsg_add_str(e, "key", "main");
    htsmsg_add_str(e, "val", "Main (better results)");
    htsmsg_add_msg(l, NULL, e);
    e = htsmsg_create_map();
    htsmsg_add_str(e, "key", "high");
    htsmsg_add_str(e, "val", "High (best results)");
    htsmsg_add_msg(l, NULL, e);
    e = htsmsg_create_map();
    htsmsg_add_str(e, "key", "high10");
    htsmsg_add_str(e, "val", "High10 (best results)");
    htsmsg_add_msg(l, NULL, e);
    e = htsmsg_create_map();
    htsmsg_add_str(e, "key", "high422");
    htsmsg_add_str(e, "val", "High422 (best results)");
    htsmsg_add_msg(l, NULL, e);
    e = htsmsg_create_map();
    htsmsg_add_str(e, "key", "high444");
    htsmsg_add_str(e, "val", "High444 (best results)");
    htsmsg_add_msg(l, NULL, e);
...
static htsmsg_t *
profile_class_x264preset_list(void *o) {
    return profile_class_preset_list();
}
...
const idclass_t profile_transcode_class = {
    ...
    .ic_properties = (const property_t[])
    {
        ...
        },
        {
            ...
            .id = "x264preset",
            .name = "Preset",
            .off = offsetof(profile_transcode_t, pro_x264preset),
            .def.s = "Default",
            .list = profile_class_x264preset_list,
        },
        {
            .type = PT_STR,
            .id = "x264profile",
            .name = "Profile",
            .off = offsetof(profile_transcode_t, pro_x264profile),
            .def.s = "Default",
            .list = profile_class_x264profile_list,
        },
        {
            .type = PT_STR,
            .id = "x264level",
            .name = "Level",
            .off = offsetof(profile_transcode_t, pro_x264level),
            .def.s = "Default",
            .list = profile_class_x264level_list,
        },
        {
            .type = PT_STR,
            .id = "tune",
