...
FFMPEG_CONFIG_MAK=1
FFMPEG_CONFIGURATION=--prefix=/ffmpeg --disable-all --enable-static --disable-shared --enable-gpl --extra-cflags=-I/opt/development/tvheadend/libav_static/build/ffmpeg/include --extra-libs='-L/opt/development/tvheadend/libav_static/build/ffmpeg/lib -ldl' --enable-libx264 --enable-libvorbis --enable-libvpx --enable-avutil --enable-avformat --enable-avcodec --enable-swresample --enable-swscale --enable-avresample --enable-decoder=mpeg2video --enable-decoder=mp2 --enable-decoder=ac3 --enable-decoder=eac3 --enable-decoder=h264 --enable-decoder=h264_vdpau --enable-decoder=aac --enable-decoder=aac_latm --enable-decoder=vorbis --enable-decoder=libvorbis --enable-encoder=mpeg2video --enable-encoder=mp2 --enable-encoder=libx264 --enable-encoder=libvpx_vp8 --enable-encoder=libvpx_vp9 --enable-encoder=aac --enable-encoder=libaacplus --enable-encoder=vorbis --enable-encoder=libvorbis --enable-muxer=mpegts --enable-muxer=mpeg2dvd --enable-muxer=matroska --enable-muxer=webm --enable-bsf=h264_mp4toannexb
prefix=/ffmpeg
...
CC_IDENT=gcc 4.9.1 (Ubuntu 4.9.1-16ubuntu6)
ARCH=x86
INTRINSICS=none
CC=gcc
CXX=g++
...
CFLAGS=  -I/opt/development/tvheadend/libav_static/build/ffmpeg/include -std=c99 -fomit-frame-pointer -pthread  -g -Wdeclaration-after-statement -Wall -Wdisabled-optimization -Wpointer-arith -Wredundant-decls -Wwrite-strings -Wtype-limits -Wundef -Wmissing-prototypes -Wno-pointer-to-int-cast -Wstrict-prototypes -Wempty-body -Wno-parentheses -Wno-switch -Wno-format-zero-length -Wno-pointer-sign -O3 -fno-math-errno -fno-signed-zeros -fno-tree-vectorize -Werror=format-security -Werror=implicit-function-declaration -Werror=missing-prototypes -Werror=return-type -Werror=vla -Wformat -fdiagnostics-color=auto -Wno-maybe-uninitialized
CXXFLAGS=  -D__STDC_CONSTANT_MACROS
ASFLAGS=  -I/opt/development/tvheadend/libav_static/build/ffmpeg/include -g
AS_C=-c
AS_O=-o $@
CC_C=-c
CC_E=-E -o $@
...
EXTRALIBS=-lxcb -lxcb-shm -lxcb -lxcb-xfixes -lxcb-render -lxcb-shape -lxcb -lxcb-shape -lxcb -lX11 -lx264 -lvpx -lvpx -lvorbisenc -lvorbis -logg -lm -lz -pthread -L/opt/development/tvheadend/libav_static/build/ffmpeg/lib -ldl 
COMPAT_OBJS=
EXEOBJS=
INSTALL=install
LIBTARGET=
